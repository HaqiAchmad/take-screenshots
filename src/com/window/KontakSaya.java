...
public class KontakSaya extends javax.swing.JFrame {
    ...
    public KontakSaya() {
        ...
        this.setTitle(setting.getLanguageActived("Contact Developer", "Kontak Developer", "Kontak Pengembang", "開発者に連絡する", "Kaihatsu-sha ni renraku suru", "개발자에게 문의", "gaebalja-ege mun-ui"));
        this.setIconImage(Apps.getWindowIcon());
        this.lblKontaksaya.setText(setting.getLanguageActived("Contact Developer", "Kontak Developer", "Kontak Pengembang", "開発者に連絡する", "Kaihatsu-sha ni renraku suru", "개발자에게 문의", "gaebalja-ege mun-ui"));
    ...
    private void setThemes(){
        ...
        this.lblKontaksaya.setForeground(setting.getThemeColors(new Color(0,0,0), new Color(255,255,255)));
        this.txtWhatsapp.setForeground(setting.getThemeColors(new Color(0,0,0), new Color(255,255,255)));
        this.txtInstagram.setForeground(setting.getThemeColors(new Color(0,0,0), new Color(255,255,255)));
        this.txtTwitter.setForeground(setting.getThemeColors(new Color(0,0,0), new Color(255,255,255)));
        this.txtYoutube.setForeground(setting.getThemeColors(new Color(0,0,0), new Color(255,255,255)));
    }
