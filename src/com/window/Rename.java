...
public class Rename extends javax.swing.JFrame {
    ...
    /**
     * untuk mendapatkan setelan aplikasi
     */
    ...
    public Rename() {
        initComponents();
        this.gambar = new File(this.screenshot.getLastScreenshot());
    ...
    private void setThemes(){
        ...
        this.pnlMain.setBackground(setting.getThemeColors(new Color(239,240,240), new Color(35, 35, 37)));
        this.btnSave.setBackground(setting.getThemeColors(new Color(223,224,224), new Color(57, 60, 64)));
        this.btnBatal.setBackground(setting.getThemeColors(new Color(223,224,224), new Color(57, 60, 64)));
        this.inpNama.setBackground(setting.getThemeColors(new Color(239,240,240), new Color(43,43,43)));
        
        this.btnSave.setForeground(setting.getThemeColors(new Color(21,18,18), new Color(248,244,244)));
        this.btnBatal.setForeground(setting.getThemeColors(new Color(21,18,18), new Color(248,244,244)));
        this.inpNama.setForeground(setting.getThemeColors(new Color(0,0,0), new Color(237,236,236)));
        this.inpNama.setCaretColor(setting.getThemeColors(new Color(0,0,0), new Color(255,255,255)));
        this.lblTop.setForeground(setting.getThemeColors(new Color(0,0,0), new Color(255,255,255)));
        this.lblNama.setForeground(setting.getThemeColors(new Color(16,0,11), new Color(237,237,237)));
    }
    ...
    private void setLanguage(){
        ...
        this.lblNama.setText(setting.getLanguageActived(
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        Aktivitas.addAktivitas(Waktu.getTanggal_Aktivitas() +"\t->"+ Apps.getUsername() + " membuka window Rename()"); 
    }//GEN-LAST:event_formWindowOpened

    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        Aktivitas.addAktivitas(Waktu.getTanggal_Aktivitas() +"\t->"+ Apps.getUsername() + " keluar dari window Rename()"); 
...
//        this.setLocation(x-xx, y-yy);
    ...
    public void aksiBtnSimpan(){
        ...
        Aktivitas.addAktivitas(Waktu.getTanggal_Aktivitas() +"\t->"+ Apps.getUsername() + " mengubah nama gambar dari ("+ gambar.getName() +") menjadi > " + inpNama.getText()+"."); 
        screenshot.setLastScreenshot(this.gambar.getParent() +"\\"+ inpNama.getText() + setting.getSetting(setting.SETTING_FORMAT));
        dispose();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        boolean isExist = Files.isExistFile(gambar.getParent()+"\\"+inpNama.getText() + setting.getSetting(setting.SETTING_FORMAT)); // biar g error :)
        if(isExist){
    ...
    private void btnSaveMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSaveMouseEntered
        this.btnSave.setBackground(setting.getThemeColors(new Color(87,117,181), new Color(31,83,130)));
        this.btnSave.setForeground(setting.getThemeColors(new Color(255,255,255), new Color(255,255,255)));      
    ...
    private void btnBatalMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnBatalMouseEntered
        this.btnBatal.setBackground(setting.getThemeColors(new Color(87,117,181), new Color(31,83,130)));
        this.btnBatal.setForeground(setting.getThemeColors(new Color(255,255,255), new Color(255,255,255)));
