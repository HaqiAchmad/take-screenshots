 ...
 * Class ini dulu bernama MainWindow tapi saat ini bernama MainWindow
 * 
...
public class MainWindow extends javax.swing.JFrame {
    ...
    /**
     * untuk mendapatkan data-data dari aplikasi
     */
    private final Apps app = new Apps();
    /**
     * untuk mendapatkan setingan aplikasi
     */
    ...
    public MainWindow() {
        ...
        this.setTitle(app.getName() +" " + app.getVersion());
        ...
        this.txtDirektori.setText(setting.getSetting(Settings.SETTING_PEYIMPANAN));
        ...
        this.lblTotalSS.setText(app.getTotalScreenshots() + " screenshot diambil.");
    ...
    private void setThemes(){
        this.panelMain.setBackground(setting.getThemeColors(new Color(234,238,241), new Color(35,35,37)));
        this.btnScreenshot.setBackground(setting.getThemeColors(new Color(40,87,186), new Color(61,113,219)));
        this.btnSaveTo.setBackground(setting.getThemeColors(new Color(255,255,255), new Color(28,25,25)));
        this.opsAutosave.setBackground(setting.getThemeColors(new Color(234,238,241), new Color(35,35,37)));
        this.txtDirektori.setBackground(setting.getThemeColors(new Color(215,221,223), new Color(45,48,49)));
        
        this.btnScreenshot.setForeground(setting.getThemeColors(new Color(255,255,255), new Color(34,31,31)));
        this.btnSaveTo.setForeground(setting.getThemeColors(new Color(20,20,20), new Color(255,255,255)));
        this.txtDirektori.setForeground(setting.getThemeColors(new Color(21,24,30), new Color(231,232,233)));
        this.opsAutosave.setForeground(setting.getThemeColors(new Color(13,13,13), new Color(248,248,248)));
        this.lblSimpan.setForeground(setting.getThemeColors(new Color(16,17,24), new Color(248,248,248)));
        this.lblCopyright.setForeground(setting.getThemeColors(new Color(89,89,89), new Color(142,137,137)));
        this.lblTotalSS.setForeground(setting.getThemeColors(new Color(16,15,15), new Color(248,248,248)));
        
        
        this.lblCamera.setIcon(setting.getThemeIcons(new ImageIcon(getClass().getResource("/com/media/icons/app-window-root-camera-daymode.png")), 
                                                      new ImageIcon(getClass().getResource("/com/media/icons/app-window-root-camera-darkmode.png"))));
        this.btnScreenshot.setIcon(setting.getThemeIcons(new ImageIcon(getClass().getResource("/com/media/icons/app-window-root-btnScreenshot-daymode.png")), 
                                                         new ImageIcon(getClass().getResource("/com/media/icons/app-window-root-btnScreenshot-darkmode.png"))));
        this.lblSetting.setIcon(setting.getThemeIcons(new ImageIcon(getClass().getResource("/com/media/icons/app-window-root-setting-daymode.png")), 
                                                      new ImageIcon(getClass().getResource("/com/media/icons/app-window-root-setting-darkmode.png"))));
        
    }

    private void setLanguage(){
        this.btnScreenshot.setText(setting.getLanguageActived(
                "Take Screenshot","Ambil Screenshot", "Njupuk Gambar","スクリーンショット","Sukurīnshotto","스크린 샷","seukeulin syas"
        ));
        this.opsAutosave.setText(setting.getLanguageActived(
                "autosave","autosave", "otomatis", "自動保存","Jidō hozon","자동 저장","jadongjeog"
        ));
        this.lblSimpan.setText(setting.getLanguageActived(
                "Save to :","Simpan ke :", "Panggon : " , "に保存 : ","Ni hozon : ","에 저장 : ","e jeojang : "
        ));
        this.lblTotalSS.setText(app.getTotalScreenshots()+" "+ setting.getLanguageActived(
    ...
    private void initComponents() {
        ...
        lblSetting.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/media/icons/app-window-root-setting-daymode.png"))); // NOI18N
        ...
        panelMainLayout.setVerticalGroup(
            panelMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panelMainLayout.createSequentialGroup()
                .addComponent(lblSetting, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        Aktivitas.addAktivitas(Waktu.getTanggal_Aktivitas() +"\t-> " + Apps.getUsername() + " membuka window MainWindow().");
    }//GEN-LAST:event_formWindowOpened

    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        Aktivitas.addAktivitas(Waktu.getTanggal_Aktivitas() +"\t-> " + Apps.getUsername() + " keluar dari window MainWindow().");
...
//        System.out.println(evt.getKeyCode());
    ...
    private void btnScreenshotMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnScreenshotMouseEntered
        this.btnScreenshot.setBackground(setting.getThemeColors(new Color(34,71,147), new Color(28,99,246)));
        this.btnScreenshot.setForeground(setting.getThemeColors(new Color(176,176,178), new Color(34,31,31)));
        try{
            Thread.sleep(200);
            this.lblCamera.setIcon(setting.getThemeIcons(new ImageIcon(getClass().getResource("/com/media/icons/app-window-root-camera-daymode-entered.png")), 
                                                          new ImageIcon(getClass().getResource("/com/media/icons/app-window-root-camera-darkmode-entered.png"))));

        }catch(InterruptedException iex){
            Apps.showException("Terjadi kesalahan yang tidak diketahui", MainWindow.class.getName(), iex.toString());
    ...
    private void btnScreenshotActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnScreenshotActionPerformed
        int totalSS = app.getTotalScreenshots(); // untuk mendapatkan total screenshot sebelumnya dan ditambahkan 1
        String date = Waktu.getTanggal_Screenshot(), // mendapatkan waktu saat ini untuk penamaan hasil screenshot
               filename = "Screenshot (" + Integer.toString(totalSS+1) +") " + date;// example : Screenshot (1) 2020-01-12 13.36.10
 
        try{
            this.setCursor(new Cursor(Cursor.WAIT_CURSOR));
            this.setVisible(false);
            this.screenshot.playSoundEffect();
            Thread.sleep(290);  // agar window root visible terlebih dahulu sebelum mengambil screenshot               
            app.updateTotalScreenshot(); // mengupdate total screenshot
            this.screenshot.ambilScreenshot(filename); // mengambil screenshot layar
            Aktivitas.addAktivitas(Waktu.getTanggal_Aktivitas() +"\t-> " + Apps.getUsername() + " melakukan screenshot."); // menambahkan ke aktivitas bahwa user melakukan screenshot
            this.lblTotalSS.setText(app.getTotalScreenshots()+" "+ setting.getLanguageActived(
                    "screenshot taken...","screenshot diambil...", "gambar dijupuk...", "取りました...","Torimashita...","촬영...","chwal-yeong..."
            ));
            ...
            public void run(){
                ...
                try{
                    if(opsAutosave.isSelected()){
                        setting.setSettings(Settings.SETTING_AUTOSAVE, "actived");
                        setVisible(true);
                    }else{
                        setting.setSettings(Settings.SETTING_AUTOSAVE, "deactived");
                    ...
                    Apps.showException("Mungkin ada file yang terhapus didatabase", MainWindow.class.getName(), ex.toString());
                }
            }
        });
    ...
    private void btnSaveToActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveToActionPerformed
        try{
            ...
            int returnNilai = jfc.showSaveDialog(null);
                ...
                if(returnNilai == javax.swing.JFileChooser.APPROVE_OPTION){
                    if(jfc.getSelectedFile().isDirectory()){
                        ...
                        setting.setSettings(Settings.SETTING_PEYIMPANAN, jfc.getSelectedFile().getPath() + "\\");
            ...
            Apps.showException("Mungkin OS tidak mendukung membuat file di folder ini", MainWindow.class.getName(), ex.toString());
        }
    ...
    private void lblCopyrightMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblCopyrightMouseClicked
        ...
        JOptionPane.showMessageDialog(null, "Copyright © " +  "2020-" + app.getReleased() + ". " +app.getAuthor()+". All Rights Reserved.");
