...
public class Ratting extends javax.swing.JFrame {
    ...
    private void setThemes(){
        ...
        this.btnKirim.setBackground(setting.getThemeColors(new Color(193,193,193), new Color(57,60,64)));
        this.btnNanti.setBackground(setting.getThemeColors(new Color(193,193,193), new Color(57,60,64)));
        this.inputNama.setBackground(setting.getThemeColors(new Color(250,250,250), new Color(45,48,49)));
        this.inputMasukan.setBackground(setting.getThemeColors(new Color(250,250,250), new Color(45,48,49)));
        
        this.btnKirim.setForeground(setting.getThemeColors(new Color(5,5,5), new Color(255,255,255)));
        this.btnNanti.setForeground(setting.getThemeColors(new Color(5,5,5), new Color(255,255,255)));
        this.inputNama.setForeground(setting.getThemeColors(new Color(0,0,0), new Color(255,255,255)));
        this.inputNama.setCaretColor(setting.getThemeColors(new Color(0,0,0), new Color(255,255,255)));
        this.inputMasukan.setForeground(setting.getThemeColors(new Color(0,0,0), new Color(255,255,255)));
        this.inputMasukan.setCaretColor(setting.getThemeColors(new Color(0,0,0), new Color(255,255,255)));
        this.lblNama.setForeground(setting.getThemeColors(new Color(0,0,0), new Color(255,255,255)));
        this.lblMasukan.setForeground(setting.getThemeColors(new Color(0,0,0), new Color(255,255,255)));
        this.lblRatting.setForeground(setting.getThemeColors(new Color(0,0,0), new Color(255,255,255)));
        this.lblEmot.setForeground(setting.getThemeColors(new Color(0,0,0), new Color(255,255,255)));
        this.lblKontak.setForeground(setting.getThemeColors(new Color(58,90,223), new Color(255,51,51)));
    }
    
    private void setLanguage(){
        this.lblNama.setText("  "+setting.getLanguageActived("Your name", "Nama kamu", "Jeneng mu", "あなたの名前", "Anata no namae", "당신의 이름", "dangsin-ui ileum"));
        this.lblMasukan.setText("  "+setting.getLanguageActived("Feedback", "Masukan", "Masukan",  "フィードバック", "Fīdobakku", "피드백", "pideubaeg"));
        this.lblRatting.setText("  "+setting.getLanguageActived("Ratting" ,"Ratting", "Rating", "ラッティング", "Rattingu", "라팅", "lating"));

        this.lblKontak.setText(setting.getLanguageActived("Contact Developer...", "Kontak Developer...", "Kontak Pengembang...", "開発者に連絡する", "Kaihatsu-sha ni renraku suru", "개발자에게 문의", "gaebalja-ege mun-ui"));
        this.btnKirim.setText(setting.getLanguageActived("Send", "Kirim", "Ngirim", "それを送る", "Sore o okuru", "보내", "bonae"));
        this.btnNanti.setText(setting.getLanguageActived("Later", "Nanti", "Mengko", "後で", "Atode", "나중", "Najung"));
    }
                ...
                .addGroup(pnlMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlMainLayout.createSequentialGroup()
                        .addGroup(pnlMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lblKontak, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(6, 6, 6)
                        .addGroup(pnlMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlMainLayout.createSequentialGroup()
    ...
    private void star1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_star1MouseClicked
         ...
         this.lblEmot.setIcon(setting.getThemeIcons(new javax.swing.ImageIcon(getClass().getResource("/com/media/icons/app-windowratting-emot-benci.png")), 
                                                     new javax.swing.ImageIcon(getClass().getResource("/com/media/icons/app-windowratting-emot-benci-darkmode.png"))
         ));
         this.lblEmot.setText(setting.getLanguageActived("Hate", "Benci", "Sengit", "嫌い", "Kirai", "미움", "Mium"));
    ...
    private void star2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_star2MouseClicked
         ...
         this.star4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/media/icons/app-windowratting-bintang-kosong.png")));
         this.star5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/media/icons/app-windowratting-bintang-kosong.png")));
         this.lblEmot.setIcon(setting.getThemeIcons(new javax.swing.ImageIcon(getClass().getResource("/com/media/icons/app-windowratting-emot-tidaksuka.png")), 
                                                     new javax.swing.ImageIcon(getClass().getResource("/com/media/icons/app-windowratting-emot-tidaksuka-darkmode.png"))
         ));
         this.lblEmot.setText(setting.getLanguageActived("Dislike" ,"Tidak suka", "Ora seneng", "好きではない", "Sukide wanai", "싫어", "silh-eo"));
    ...
    private void star3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_star3MouseClicked
         ...
         this.star4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/media/icons/app-windowratting-bintang-kosong.png")));
         this.star5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/media/icons/app-windowratting-bintang-kosong.png")));
         this.lblEmot.setIcon(setting.getThemeIcons(new javax.swing.ImageIcon(getClass().getResource("/com/media/icons/app-windowratting-emot-lumayan.png")), 
                                                     new javax.swing.ImageIcon(getClass().getResource("/com/media/icons/app-windowratting-emot-lumayan-darkmode.png"))
         ));
         this.lblEmot.setText(setting.getLanguageActived("Not bad", "Lumayan", "Ora elek", "悪くない", "Warukunai", "나쁘지 않다", "nappeuji anhda"));
    ...
    private void star4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_star4MouseClicked
         ...
         this.star5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/media/icons/app-windowratting-bintang-kosong.png")));
         this.lblEmot.setIcon(setting.getThemeIcons(new javax.swing.ImageIcon(getClass().getResource("/com/media/icons/app-windowratting-emot-suka.png")), 
                                                     new javax.swing.ImageIcon(getClass().getResource("/com/media/icons/app-windowratting-emot-suka-darkmode.png"))
         ));
         this.lblEmot.setText(setting.getLanguageActived("Like", "Suka", "Seneng", "いいね", "Ī ne", "그 것처럼", "geu geoscheoleom"));
    ...
    private void star5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_star5MouseClicked
         ...
         this.lblEmot.setIcon(setting.getThemeIcons(new javax.swing.ImageIcon(getClass().getResource("/com/media/icons/app-windowratting-emot-cinta.png")), 
                                                     new javax.swing.ImageIcon(getClass().getResource("/com/media/icons/app-windowratting-emot-cinta-darkmode.png"))
         ));
         this.lblEmot.setText(setting.getLanguageActived("Love", "Cinta", "Katresnan", "愛", "Ai", "사랑", "salang"));
